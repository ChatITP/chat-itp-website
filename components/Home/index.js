...
export default function Home() {
  return (
    ...
    <div id="home" className="h-screen min-h-[640px] block pt-[60px]">
      <div className = "h-full min-h-full items-center place-content-center flex flex-col">
        ...
        <div className="w-[727px] h-[100.93px]">
          <h2 className="text-base text-left">We are training an ethical, open-source LLM using 20+ years of ITP/NYU student work - including video, sculpture, writing, animation, game design, and virtual reality.</h2>
        </div>
      </div>
